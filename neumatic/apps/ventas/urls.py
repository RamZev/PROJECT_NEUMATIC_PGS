...
urlpatterns = [
	...
	path('clientes/autorizacion-fac-rem/', autorizacion_fac_rem, name='autorizacion_fac_rem'),
    path('clientes/autorizacion-ncr/', autorizacion_ncr, name='autorizacion_ncr'),

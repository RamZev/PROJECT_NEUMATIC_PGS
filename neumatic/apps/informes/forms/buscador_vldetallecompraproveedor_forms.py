# neumatic\apps\informes\forms\buscador_vldetallecompraproveedor_forms.py
...
class BuscadorDetalleCompraProveedorForm(InformesGenericForm):
	
	proveedor = forms.ModelChoiceField(
		queryset=Proveedor.objects.filter(estatus_proveedor=True), 
		required=True,
		label="Proveedor",

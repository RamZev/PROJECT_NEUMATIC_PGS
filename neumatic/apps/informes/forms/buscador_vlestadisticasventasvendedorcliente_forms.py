# neumatic\apps\informes\forms\buscador_vlestadisticasventasvendedorcliente_forms.py
...
from entorno.constantes_base import AGRUPAR, MOSTRAR, ESTADISTICAS


class BuscadorEstadisticasVentasVendedorClienteForm(InformesGenericForm):
	...
	estadisticas = forms.ChoiceField(
		choices=ESTADISTICAS, 
		label="Estadísticas", 
		required=True,
		widget=forms.Select(attrs={**formclassselect})
	)

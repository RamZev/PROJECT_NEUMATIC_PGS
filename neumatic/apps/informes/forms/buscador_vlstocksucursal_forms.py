# neumatic\apps\informes\forms\buscador_vlstocksucursal_forms.py
from django import forms

from .informes_generics_forms import InformesGenericForm
from apps.maestros.models.base_models import ProductoDeposito
from diseno_base.diseno_bootstrap import formclasstext, formclassselect, formclasscheck


class BuscadorStockSucursalForm(InformesGenericForm):

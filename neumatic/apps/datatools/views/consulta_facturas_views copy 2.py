		...
		try:
			...
			for key, value in request.POST.items():
				if key.startswith('retirar_'):
					...
					cantidad_retirar = Decimal(value) if value else Decimal('0')
					...
					if cantidad_retirar > 0:
						...
						if cantidad_retirar <= saldo:
							...
							retirado_actual = stock_item.retirado or Decimal('0')
							nuevo_retirado = retirado_actual + Decimal(str(cantidad_retirar))
							...
							datos_entrega['total_items'] += float(cantidad_retirar)  # o mantener como Decimal

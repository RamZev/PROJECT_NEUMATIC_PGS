...
from ..forms.producto_stock_forms import ProductoStockForm
...
class DataViewList():
	...
	table_headers = {
		'id_producto': (4, 'Producto'),
		'id_deposito': (4, 'Fecha Depósito'),
		'stock': (2, 'Stock'),
		'acciones': (2, 'Acciones'),
	}
...
class ProductoStockListView(MaestroListView):
...
class ProductoStockCreateView(MaestroCreateView):
	model = ConfigViews.model
	list_view_name = ConfigViews.list_view_name
...
class ProductoStockUpdateView(MaestroUpdateView):
	model = ConfigViews.model
	list_view_name = ConfigViews.list_view_name
	form_class = ConfigViews.form_class
	template_name = ConfigViews.template_form
...
class ProductoStockDetailView(MaestroDetailView):
	model = ConfigViews.model
	form_class = ConfigViews.form_class
	list_view_name = ConfigViews.list_view_name
	update_view_name = ConfigViews.update_view_name
...
class ProductoStockDeleteView (MaestroDeleteView):
	model = ConfigViews.model
	list_view_name = ConfigViews.list_view_name

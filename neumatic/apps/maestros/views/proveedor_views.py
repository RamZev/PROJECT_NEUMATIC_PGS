# neumatic\apps\maestros\views\proveedor_views.py
...
class DataViewList():
	...
	table_headers = {
		'estatus_proveedor': (1, 'Estatus'),
		'id_proveedor': (1, 'ID'),
		'nombre_proveedor': (4, 'Nombre proveedor'),
		'cuit': (2, 'C.U.I.T.'),
		'telefono_proveedor': (2, 'Taléfono'),
		
		'acciones': (2, 'Acciones'),
	}
	
	table_data = [
		{'field_name': 'estatus_proveedor', 'date_format': None},
...
class ProveedorDetailView(MaestroDetailView):
	model = ConfigViews.model
	form_class = ConfigViews.form_class
	list_view_name = ConfigViews.list_view_name
	update_view_name = ConfigViews.update_view_name

...
urlpatterns = [
	...
	path('actividad/<int:pk>/ver/', ActividadDetailView.as_view(), name='actividad_detail'),
	...
	path('producto_deposito/<int:pk>/ver/', ProductoDepositoDetailView.as_view(), name='producto_deposito_detail'),
	...
	path('producto_familia/<int:pk>/ver/', ProductoFamiliaDetailView.as_view(), name='producto_familia_detail'),
	...
	path('producto_marca/<int:pk>/ver/', ProductoMarcaDetailView.as_view(), name='producto_marca_detail'),
	...
	path('producto_modelo/<int:pk>/ver/', ProductoModeloDetailView.as_view(), name='producto_modelo_detail'),
	...
	path('producto_cai/<int:pk>/ver/', ProductoCaiDetailView.as_view(), name='producto_cai_detail'),
	...
	path('producto_minimo/<int:pk>/ver/', ProductoMinimoDetailView.as_view(), name='producto_minimo_detail'),
	...
	path('producto_stock/<int:pk>/ver/', ProductoStockDetailView.as_view(), name='producto_stock_detail'),
	...
	path('producto_estado/<int:pk>/ver/', ProductoEstadoDetailView.as_view(), name='producto_estado_detail'),
	...
	path('comprobante_venta/<int:pk>/ver/', ComprobanteVentaDetailView.as_view(), name='comprobante_venta_detail'),
	...
	path('comprobante_compra/<int:pk>/ver/', ComprobanteCompraDetailView.as_view(), name='comprobante_compra_detail'),
	...
	path('moneda/<int:pk>/ver/', MonedaDetailView.as_view(), name='moneda_detail'),
	...
	path('provincia/<int:pk>/ver/', ProvinciaDetailView.as_view(), name='provincia_detail'),
	...
	path('localidad/<int:pk>/ver/', LocalidadDetailView.as_view(), name='localidad_detail'),
	...
	path('tipo_documento_identidad/<int:pk>/ver/', TipoDocumentoIdentidadDetailView.as_view(), name='tipo_documento_identidad_detail'),
	...
	path('tipo_iva/<int:pk>/ver/', TipoIvaDetailView.as_view(), name='tipo_iva_detail'),
	...
	path('alicuota_iva/<int:pk>/ver/', AlicuotaIvaDetailView.as_view(), name='alicuota_iva_detail'),
	...
	path('tipo_percepcion_ib/<int:pk>/ver/', TipoPercepcionIbDetailView.as_view(), name='tipo_percepcion_ib_detail'),
	...
	path('tipo_retencion_ib/<int:pk>/ver/', TipoRetencionIbDetailView.as_view(), name='tipo_retencion_ib_detail'),
	...
	path('operario/<int:pk>/ver/', OperarioDetailView.as_view(), name='operario_detail'),
	...
	path('cliente/<int:pk>/ver/', ClienteDetailView.as_view(), name='cliente_detail'),
	...
	path('proveedor/<int:pk>/ver/', ProveedorDetailView.as_view(), name='proveedor_detail'),
	...
	path('producto/<int:pk>/ver/', ProductoDetailView.as_view(), name='producto_detail'),
	...
	path('vendedor/<int:pk>/ver/', VendedorDetailView.as_view(), name='vendedor_detail'),
	...
	path('empresa/<int:pk>/ver/', EmpresaDetailView.as_view(), name='empresa_detail'),
	...
	path('sucursal/<int:pk>/ver/', SucursalDetailView.as_view(), name='sucursal_detail'),
	...
	path('parametro/<int:pk>/ver/', ParametroDetailView.as_view(), name='parametro_detail'),
	...
	path('numero/<int:pk>/ver/', NumeroDetailView.as_view(), name='numero_detail'),
	...
	path('medio_pago/<int:pk>/ver/', MedioPagoDetailView.as_view(), name='medio_pago_detail'),
	...
	path('punto_venta/<int:pk>/ver/', PuntoVentaDetailView.as_view(), name='punto_venta_detail'),
	...
	path('valida/<int:pk>/ver/', ValidaDetailView.as_view(), name='valida_detail'),
	...
	path('banco/<int:pk>/ver/', BancoDetailView.as_view(), name='banco_detail'),
	...
	path('cuenta_banco/<int:pk>/ver/', CuentaBancoDetailView.as_view(), name='cuenta_banco_detail'),
	...
	path('tarjeta/<int:pk>/ver/', TarjetaDetailView.as_view(), name='tarjeta_detail'),
	...
	path('codigo_retencion/<int:pk>/ver/', CodigoRetencionDetailView.as_view(), name='codigo_retencion_detail'),
	...
	path('concepto_banco/<int:pk>/ver/', ConceptoBancoDetailView.as_view(), name='concepto_banco_detail'),
	...
	path('marketing_origen/<int:pk>/ver/', MarketingOrigenDetailView.as_view(), name='marketing_origen_detail'),
	...
	path('cai-estados/<int:pk>/ver/', CaiEstadosDetailView.as_view(), name='cai_estados_detail'),
	...
	path('forma_pago/<int:pk>/ver/', FormaPagoDetailView.as_view(), name='forma_pago_detail'),
	...
	path('descuento_vendedor/<int:pk>/ver/', DescuentoVendedorDetailView.as_view(), name='descuento_vendedor_detail'),
	...
	path('descuento_revendedor/<int:pk>/ver/', DescuentoRevendedorDetailView.as_view(), name='descuento_revendedor_detail'),
